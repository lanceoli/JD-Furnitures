...
<nav class="site-nav grid"> 
    <a href="UT-adminorders.php"><img src="assets/img/Back.png" alt=""></a>
    <p>Add Order</p>
</nav>

<form action="UT-add-order.php" method="post" enctype="multipart/form-data" oninput="range1value.value = progress.valueAsNumber" 
