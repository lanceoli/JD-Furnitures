...
<form action="add-product.php" method="post" enctype="multipart/form-data" onkeydown="return stopFormSubmission(event)">
    ...
    <div id="furnitureModal" class="modal" style="z-index:3;">
