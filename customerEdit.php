...
<nav class="site-nav grid"> 
    <a href="customer.php?cust=<?php echo $cust_num ?>"><img src="assets/img/Back.png" alt=""></a>
    <p>Edit Customer Info</p>
</nav>

<form action="editcustomer.php?cust=<?php echo $cust_num ?>" method="post" enctype="multipart/form-data">
<?php 
if(isset($_GET['error'])){
...
echo''?>
    ...
    <div class="edit-form">
            <p>Middle Name</p>
            <input type="text" name="middle-name"  id="middle-name" value="<?php echo $customer["MIDDLE_NAME"]?>">
    </div>
    <div class="edit-form">
            <p>Birthday</p>
