...
<head>
    ...
    <link rel="stylesheet" href="UT-admin.css">
    ...
    <?php 
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                echo '<a class="create-button" href="UT-customer.php?cust=' . urlencode($row["CUST_NUM"]) . '">
                    <div class="card grid">
...
while($customer = $result->fetch_assoc()){
    echo '<a class="create-button" href="UT-customer.php?cust='?><?php echo urlencode($customer["CUST_NUM"]) ?>">
...
<div class="create-gen grid">
    <div class="create-record">
            <a class="create-button" href="UT-create.php">
                <img src="assets/img/Create.png" alt="">
                <p>Create <br>Record</p>
            </a>
    </div>
    <div class="generate-chart">
        <a class="generate-button" href="UT-adminGenChart.php">
