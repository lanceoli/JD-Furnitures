...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    empty(trim($bus_loc)) || empty(trim($mode_pay))){
        header('Location: UT-customerEdit.php?cust=' . $cust_num . '&error=missing');
        exit();
    }elseif(!filter_var($email, FILTER_VALIDATE_EMAIL)){
        header('Location: UT-customerEdit.php?cust=' . $cust_num . '&error=notem');
        exit();
    }
    ...
    do{
        ...
        $cust_link = "Location: UT-customer.php?cust=" . $cust_num;
